...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    GPIO_InitStruct.Pin = VPWR_Pin|V1V2_Pin|V3V3_Pin|AI2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = V5V_Pin|VUSB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF12     ------> ADC1_INP6
    */
    HAL_GPIO_DeInit(GPIOA, VPWR_Pin|V1V2_Pin|V3V3_Pin|AI2_Pin);

    HAL_GPIO_DeInit(GPIOB, V5V_Pin|VUSB_Pin);

    HAL_GPIO_DeInit(AI1_GPIO_Port, AI1_Pin);
