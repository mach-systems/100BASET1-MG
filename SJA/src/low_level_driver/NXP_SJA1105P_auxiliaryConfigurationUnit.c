...
/**
* \brief Convert an enum of type ::SJA1105P_tempThreshold_t to an signed stdint int16_t
*
* \param[in]  SJA1105P_tempThreshold_t Value to be converted
*
* \return SJA1105P_tempThreshold_t
*/
int16_t SJA1105P_convertToTemp(SJA1105P_tempThreshold_t thresholdValue)
{
    int16_t ret;
    switch (thresholdValue)
    {
        case SJA1105P_e_tempThreshold_POSITIVE135P5: ret = 135; break;
        case SJA1105P_e_tempThreshold_POSITIVE130P5: ret = 130; break;
        case SJA1105P_e_tempThreshold_POSITIVE125P5: ret = 125; break;
        case SJA1105P_e_tempThreshold_POSITIVE120P7: ret = 120; break;
        case SJA1105P_e_tempThreshold_POSITIVE116P0: ret = 116; break;
        case SJA1105P_e_tempThreshold_POSITIVE111P4: ret = 111; break;
        case SJA1105P_e_tempThreshold_POSITIVE106P9: ret = 106; break;
        case SJA1105P_e_tempThreshold_POSITIVE102P5: ret = 102; break;
        case SJA1105P_e_tempThreshold_POSITIVE98P2: ret = 98; break;
        case SJA1105P_e_tempThreshold_POSITIVE92P8: ret = 92; break;
        case SJA1105P_e_tempThreshold_POSITIVE87P5: ret = 87; break;
        case SJA1105P_e_tempThreshold_POSITIVE82P4: ret = 82; break;
        case SJA1105P_e_tempThreshold_POSITIVE77P4: ret = 77; break;
        case SJA1105P_e_tempThreshold_POSITIVE72P6: ret = 72; break;
        case SJA1105P_e_tempThreshold_POSITIVE67P9: ret = 67; break;
        case SJA1105P_e_tempThreshold_POSITIVE63P3: ret = 63; break;
        case SJA1105P_e_tempThreshold_POSITIVE58P8: ret = 58; break;
        case SJA1105P_e_tempThreshold_POSITIVE54P5: ret = 54; break;
        case SJA1105P_e_tempThreshold_POSITIVE50P2: ret = 50; break;
        case SJA1105P_e_tempThreshold_POSITIVE46P1: ret = 46; break;
        case SJA1105P_e_tempThreshold_POSITIVE42P0: ret = 42; break;
        case SJA1105P_e_tempThreshold_POSITIVE36P4: ret = 36; break;
        case SJA1105P_e_tempThreshold_POSITIVE30P9: ret = 30; break;
        case SJA1105P_e_tempThreshold_POSITIVE25P6: ret = 25; break;
        case SJA1105P_e_tempThreshold_POSITIVE20P6: ret = 20; break;
        case SJA1105P_e_tempThreshold_POSITIVE15P7: ret = 15; break;
        case SJA1105P_e_tempThreshold_POSITIVE11P0: ret = 11; break;
        case SJA1105P_e_tempThreshold_POSITIVE6P4: ret = 6; break;
        case SJA1105P_e_tempThreshold_POSITIVE2P1: ret = 2; break;
        case SJA1105P_e_tempThreshold_NEGATIVE2P1: ret = -2; break;
        case SJA1105P_e_tempThreshold_NEGATIVE6P1: ret = -6; break;
        case SJA1105P_e_tempThreshold_NEGATIVE11P4: ret = -11; break;
        case SJA1105P_e_tempThreshold_NEGATIVE18P3: ret = -18; break;
        case SJA1105P_e_tempThreshold_NEGATIVE23P5: ret = -23; break;
        case SJA1105P_e_tempThreshold_NEGATIVE28P4: ret = -28; break;
        case SJA1105P_e_tempThreshold_NEGATIVE33P0: ret = -33; break;
        case SJA1105P_e_tempThreshold_NEGATIVE37P5: ret = -37; break;
        case SJA1105P_e_tempThreshold_NEGATIVE41P7: ret = -41; break;
        case SJA1105P_e_tempThreshold_NEGATIVE45P7: ret = -45; break;
        default: ret = 0; break;
    }
    return ret;
}
