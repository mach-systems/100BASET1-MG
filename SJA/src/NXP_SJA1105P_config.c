...
#define APPBOARD_PORT_MAPPING {{3, 0}, {1, 0}, {2, 0}, {4, 0}, {0, 0}} /**< Mapping between logical ports used in the driver API and the physical ports on the ICs. Syntax: {{physical port of port 0, physical switch of port 0}, ...} */

/* Port 3 --> Port 0 on switch 0 */
/* Port 1 --> Port 1 on switch 0 */
/* Port 2 --> Port 2 on switch 0 */
/* Port 4 --> Port 3 on switch 0 */
/* Port 4 --> Port 4 on switch 0 */
